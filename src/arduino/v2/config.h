...
// Drive motors.
#define PIN_MOTOR_LEFT_PWM_L 11     // Left motor forward PWM.
...
#define PIN_ENCODER_RIGHT_A 3       // Right encoder channel A.
#define PIN_ENCODER_RIGHT_B 5       // Right encoder channel B.

// Actuators.
#define PIN_AUGER_ENABLE A5         // Auger motor enable.
#define PIN_SALT_ENABLE A4          // Salt dispenser enable.
#define PIN_CHUTE_PWM 8             // Chute servo PWM.

// Safety and sensors.
#define PIN_ESTOP 7                 // E-stop button (active LOW).
#define PIN_BATTERY_SENSE A0        // Battery voltage divider.
#define ESTOP_USE_PIN 1             // Set to 0 to ignore the physical E-stop pin (software only).
...
#define ENCODER_TICKS_PER_REV 1200  // Encoder resolution (ticks/revolution).
...
#define JSON_RESPONSE_SIZE 512      // JSON response/sensor buffer size.
...
// Rates.
#define SENSOR_STREAM_PERIOD_MS 50   // Sensor stream rate is 20 Hz (used only if autonomous streaming is enabled).
